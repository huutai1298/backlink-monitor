...
- Status tính theo TỪNG BACKLINK độc lập
...
| lost → live | Ngay | Ngay |
| expired + lost/live | Ngay | Không |
| inactive still live | Mỗi 24h | Không |
| website die | Ngay | Không |
| website sống lại | Ngay | Không |
...
| Deploy | Ubuntu EC2, Nginx, Uvicorn, SSL |
